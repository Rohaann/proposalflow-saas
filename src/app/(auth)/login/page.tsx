    ...
    <div className="min-h-screen flex items-center justify-center bg-[#050807] p-4 font-sans text-white">
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-sm text-[#8FAD96]">Enter your details to sign in to your account.</p>
        </div>
        ...
        <Card className="bg-[#101D16] border-[#00DC5A]/20 shadow-2xl overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-[#8FAD96] hover:text-[#00FF73]">Forgot password?</Link>
                </div>
                <Input 
                  name="password"
                  type="password" 
          ...
          <CardFooter className="flex justify-center border-t border-[#00DC5A]/10 py-4">
            <Link href="/register" className="text-sm text-[#8FAD96] hover:text-[#00FF73] transition-colors">
