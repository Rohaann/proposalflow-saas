    ...
    <div className="min-h-screen flex items-center justify-center bg-[#050807] p-4 font-sans text-white">
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-sm text-[#8FAD96]">
            {isSignUp ? 'Sign up to generate unlimited deals.' : 'Enter your details to sign in to your account.'}
          </p>
        </div>
        ...
        <Card className="bg-[#101D16] border-[#00DC5A]/20 shadow-2xl overflow-hidden">
          <CardContent className="pt-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" onClick={() => handleOAuth('github')} className="bg-transparent border-[#00DC5A]/20 hover:bg-[#00DC5A]/10 text-white font-medium">
              ...
              <Button variant="outline" onClick={() => handleOAuth('google')} className="bg-transparent border-[#00DC5A]/20 hover:bg-[#00DC5A]/10 text-white font-medium">
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              {successMsg && (
                <div className="p-3 text-sm bg-green-500/10 border border-green-500/20 text-green-400 rounded-md">
                  {successMsg}
                </div>
              )}
          ...
          <CardFooter className="flex justify-center border-t border-[#00DC5A]/10 py-4">
            <button 
              ...
              className="text-sm text-[#8FAD96] hover:text-[#00FF73] transition-colors"
            >
